# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-06-08 09:45
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('comics', '0004_auto_20170608_1144'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follows', models.DateTimeField(auto_now_add=True, null=True)),
        ...
        migrations.AlterUniqueTogether(
            name='comicfollows',
            unique_together=set([('comic', 'user_id')]),
        ),
        migrations.AlterUniqueTogether(
            name='characterfollows',
            unique_together=set([('character', 'user_id')]),
        ),
        migrations.AlterUniqueTogether(
            name='authorfollows',
            unique_together=set([('author', 'user_id')]),
        ),
    ]
